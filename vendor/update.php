...
<body>
                        ...
                        if(mysqli_num_rows($res) > 0)
                        {
                            ...
                            ?>
                                <form action="./code.php" method="post">
                                    ...
                                    Image: <input type="file" name = "file" value="<?= $product['file'] ?>" required> <br> <br>
                                    ...
                                    <button name="update_btn" type="submit">Update</button>
                                </form>
    ...
    <!-- <script>
        let edit_product = document.getElementById('edit_ptoduct');
        ...
        function edit_product(id)
        {
            ...
            xhr.onload = function()
            {
                ...
                edit_product.elements['name'].value = data.productdata.name;
                edit_product.elements['price'].value = data.productdata.price;
                edit_product.elements['category'].value = data.productdata.category;
                edit_product.elements['file'].value = data.productdata.file;
                edit_product.elements['product_id'].value = data.productdata.id;
            }
