...
<body>
    ...
    <section id="Testimonial">
        <div class="box">
            <div class="cad">
                <img src="../images/prajwal.jpg">
                <h5>Prajwal Kiran Sunuwar</h5>
                <p>The owner and CEO of the Yakthung.</p>
                
            </div>
            <div class="cad">
                <img src="../images/dipen.jpg">
                <h5>Dipen Limbu</h5>
                <p>The Owner and CTO of the Yakthung.</p>
                
            </div>
            <div class="cad">
                <img src="../images/swostik.jpg">
                <h5>Swostik Subedi</h5>
                <p>The Owner and CFO in the Yakthung.</p>
                
            </div>
            <div class="cad">
                <img src="../images/siruj.jpg">
                <h5>Siruj Subedi</h5>
                <p>The Owner and COO in the Yakthung</p>
