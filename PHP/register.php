...
if(isset($_GET["fname"]) && isset($_GET["lname"]) && isset($_GET["Email"]) && isset($_GET["psw"]) && isset($_GET["cpsw"])){
    $fname = $_GET["fname"];
    $lname = $_GET["lname"];
    $email = $_GET["Email"];
    $psw = $_GET["psw"];
...
$query = "INSERT INTO `user_info`(`fname`, `lname`, `Email`, `psw`, `cpsw`) VALUES ('$fname', '$lname', '$email', '$psw', '$cpsw')";
echo "<br>";
echo "<br>"; 
